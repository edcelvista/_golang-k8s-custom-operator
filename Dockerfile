...
COPY custom-operator-deployment-recon-linux /usr/local/bin/
COPY custom-operator-secret-recon-linux /usr/local/bin/
COPY webhook-linux /usr/local/bin/

RUN chmod ugo+x /usr/local/bin/custom-operator-deployment-recon-linux
RUN chmod ugo+x /usr/local/bin/custom-operator-secret-recon-linux
